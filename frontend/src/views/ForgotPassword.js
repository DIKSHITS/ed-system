...
const ForgotPassword = () => {
  ...
  const handleCheckEmail = async (e) => {
    ...
    try {
      ...
      const emailCheckResponse = await axios.post('http://localhost:4000/api/check-email', { email });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      if (newPassword === confirmPassword) {
        ...
        const updateResponse = await axios.post('http://localhost:4000/api/update-password', {
          email,
          newPassword,
        });
